// constructs new editor instance
{

	/**
	 * startup sequence, constructs a new application (returns an mxEditor instance)
	 */
...
// on load creates gui and the functionality
                        ...
                        for (i=0; i<containerChildren.length; i++)
                        {
                          ...
                          if (cellType.tagName == 'Connector')
                          {
                            ...
                            for (var j = 0; j < childEdges.length; j++)
                            {
                              ...
                              {
                                var cEdgesGeo = childEdges[j].geometry;
                                console.log('point before moving', cEdgesGeo.points[0].x)
                                cEdgesGeo.points[0].x += stringRectangleGeo.width+10;
                                editor.graph.model.setGeometry(childEdges[j], cEdgesGeo);
                                console.log('after moving ', cEdgesGeo.points[0].x);
                              }
                            }
                          }
                        }
